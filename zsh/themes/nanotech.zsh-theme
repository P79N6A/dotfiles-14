    ...
    case $STATUS in
      "DIRTY" )
        if [[ -n $IS_UNPUSHED ]]; then
          GIT_CURRENT_STATUS="${ZSH_THEME_GIT_PROMPT_DIRTY}${ZSH_THEME_GIT_PROMPT_DIRTY_UNPUSHED}"
        elif [[ -n $IS_UNPULLED ]]; then
          GIT_CURRENT_STATUS="${ZSH_THEME_GIT_PROMPT_DIRTY}${ZSH_THEME_GIT_PROMPT_DIRTY_UNPULLED}"
        else
      ...
      "CLEAN" )
        if [[ -n $IS_UNPUSHED ]]; then
          GIT_CURRENT_STATUS="${ZSH_THEME_GIT_PROMPT_CLEAN}${ZSH_THEME_GIT_PROMPT_CLEAN_UNPUSHED}"
        elif [[ -n $IS_UNPULLED ]]; then
          GIT_CURRENT_STATUS="${ZSH_THEME_GIT_PROMPT_CLEAN}${ZSH_THEME_GIT_PROMPT_CLEAN_UNPULLED}"
        else
