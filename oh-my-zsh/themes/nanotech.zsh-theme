...
function _git_prompt_info() {
  ...
  echo $ZSH_THEME_GIT_PROMPT_PREFIX_BRANCH$GIT_CURRENT_BRANCH$ZSH_THEME_GIT_PROMPT_SHA$GIT_CURRENT_STATUS$ZSH_THEME_GIT_PROMPT_SUFFIX_BRANCH
}
...
ZSH_THEME_GIT_PROMPT_SHA="$(_git_prompt_short_sha)"
